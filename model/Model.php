  ...
  public static function select($primary_value) {
   ...
   public static function selectMore($primary_value,$key) {
    ...
    public static function selectWhere($attribute, $value) {
        ...
        $sql = "SELECT * from $table_name WHERE $attribute=:nom_tag";
        // Préparation de la requête
        $req_prep = Model::$pdo->prepare($sql);
        $values = array(
            "nom_tag" => $value,
    ...
    public static function selectDistinct($primary_value) {
        $table_name = static::$object;
        //echo"$primary_value";
        $primary_value = trim($primary_value);
        //echo"$primary_value";
        //var_dump($primary_value);
        //bug intéressant
        $primary_value = trim($primary_value);
        $class_name = 'Model' . $table_name;
        $sql = "SELECT DISTINCT $primary_value from $table_name";
        // Préparation de la requête
        $req_prep = Model::$pdo->prepare($sql);
        $values = array(
            "nom_tag" => trim($primary_value),
        );
        // On donne les valeurs et on exécute la requête   
        $req_prep->execute($values);
        // On récupère les résultats comme précédemment
